...
class Game:
    """
    Функция инициализирует поля класса
    """
    def __init__(self):
        ...
        self.menu()
    """ 
    Данная функция генерирует рандомное число
    """
    def gen_number(self):
    ...
    """
    В данной функции производится ввод, вызывает провуеряющую функцию и если все верно возвращает значение
    """
    def get_input(self):
        while True:
            print()
    ...
    def check_input(self, line):
        if line.isdigit() and len(line) == 3:
            ...
            return False
    """ 
    Проверка введеный значений по правилам игры 
    """
    def check(self):
        ...
        self.words = ['', '', '']
    """
    Выводит подсказки по правилам игры
    """
    def output(self):
        for i in range(0, 3):
            for j in range(0, 3):
